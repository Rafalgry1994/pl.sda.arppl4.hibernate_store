...
public class ProductCommandLineParser {
    ...
    private void handleUpdateCommand() {
        System.out.printf("Provide id of the product You'd like to update");
        ...
        if (productOptional.isPresent()) {
            ...
            System.out.printf("What would You like update[price, expiryDate, quantity");
            String output = scanner.next();
            switch (output) {
                case "name":
                    System.out.printf("Provide price");
                ...
                case "expiryDate":
                    ...
                    break;
                case "quantity":
                    System.out.printf("Provide quantity");
                    Double quantity = scanner.nextDouble();

                    product.setQuantity(quantity);
                    break;
                default:
                    System.out.printf("Field with this name is not handled");
            }
            dao.usunProduct(product);
            System.out.printf("Product has been update");
        }else {
    ...
    private void handleDeleteCommand() {
        System.out.printf("Provide id of the product You'd like to remove");
        Long id = scanner.nextLong();
    ...
    private void handleListCommand() {
        List<Product> productList = dao.zwrocListeProduct();
